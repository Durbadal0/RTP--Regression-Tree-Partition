...
bart_fn_r2=function(cov1,partitions,radius,b1,b2,N){
...
bart_fn_nim22 = nimbleFunction(run=function(cov1=double(1),partitions=double(2),radius=double(2),
...
bart_fn_nim12=nimbleRcall(function(cov1=double(1),partitions=double(2),radius=double(2),
                                   b1=double(1),b2=double(0),N=integer(0)){},Rfun='bart_fn_r2',returnType=double(1))


Cbart_fn_nim12=compileNimble(bart_fn_nim12)
...
b2=99999
cov1=c(.39,.19)
bart_fn_r2(cov1,partitions,radius,b1,b2,150)

bart_fn_nim12(cov1,partitions,radius,b1,b2,N=150)
Cbart_fn_nim12(cov1,partitions,radius,b1,b2,N=150)
bart_fn_nim22(cov1,partitions,radius,b1,b2,N=150)
...
bart_nimcode3 <- nimbleCode({
  ...
  for(k in 1:n) {
    ...
    predicted.y[k] <- bart_fn_nim22(cov2[k,1:p],parti[1:N3,1:p],radi[1:N3,1:p],b11[1:N3],b21,N2)
...
rlist::list.save(job,file="Part_job2_data1.rds")